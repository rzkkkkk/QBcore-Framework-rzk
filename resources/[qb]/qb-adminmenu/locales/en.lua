local Translations = {
    error = {
        ...
        ["missing_reason"] = "Você deve fornecer um motivo!",
        ["invalid_reason_length_ban"] = "Você deve fornecer um motivo e definir uma duração para o banimento!",
        ...
        ["failed_set_speed"] = "Você não definiu uma velocidade.. (`fast` para super-rápido, `normal` para normal)",
    ...
    success = {
        ...
        ["success.entered_vehicle"] = "veículo inserido com sucesso",
    },
    info = {
